		  	  ...
		  	  frmParsing.ATMListJournal.Add('4');
{
		  	  frmParsing.ATMListJournal.Add('5');
					frmParsing.ATMListJournal.Add('6');
		      ...
		      frmParsing.ATMListJournal.Add('14');
         ...
         frmParsing.ATMListJournal.Add('21');

         frmParsing.ATMListJournal.Add('22');

                 frmParsing.ATMListJournal.Add('23');
                 frmParsing.ATMListJournal.Add('24');
   	...
   	frmParsing.ATMListJournal.Add('27');
         ...
         frmParsing.ATMListJournal.Add('29');
...
//	frmParsing.Parse($3B);
//	frmParsing.Parse($3F); // all
  frmParsing.Parse($10); // only parseJournal
// 	frmParsing.Parse($38);
//	frmParsing.Parse($18);  //parseJournal  and Bilbo

...
if ((Pos('INDUSTRIALBANK' , fTmpStr) <> 0)
			or ((Pos('ALBANK' , fTmpStr) <> 0) and (Pos('INDYS' , fTmpStr) = 0))) then
	begin
if Assigned(fLog) then fLog.Write('0 - ' + fTmpStr);
		SetLength(fArrTrnIPS , Length(fArrTrnIPS) + 1);
      fArrTrnIPS[ind].PrintCheck := true;
      fStateTrnIPS := 1;
      fCountRowTrnIPS := 0;
...
begin
if Assigned(fLog) then fLog.Write('1 - ' + fTmpStr);
...
begin
if Assigned(fLog) then fLog.Write('2 - ' + fTmpStr);
...
begin
if Assigned(fLog) then fLog.Write('3 - ' + fTmpStr);
...
begin
if Assigned(fLog) then fLog.Write('4 - ' + fTmpStr);
   if fCOuntRowTrnIPS = 1 then
   begin
...
begin
if Assigned(fLog) then fLog.Write('5 - ' + fTmpStr);
